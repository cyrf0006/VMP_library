function corrected_shear = vmp_shear_preanalysis(shear, w, pitch, roll, p, sec)

% function corrected_shear = vmp_shear_preanalysis(shear, w, ax, ay, p, sec)
% 
...
J = find(abs(pitch) > 10 | abs(roll) > 10);
s2(J)= NaN;
