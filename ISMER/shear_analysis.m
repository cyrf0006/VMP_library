function shear_analysis(p_fname_in, p_fname_out, zbin, explicit, varargin);

% function shear_analysis(p_fname, p_fname_out, zbin)
%
% where 
...
%         F. Cyr (2010-11-23)
%             -> Check if eps1 and eps2 anre not empty, otherwise
