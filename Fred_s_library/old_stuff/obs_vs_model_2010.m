%obs_vs_model_2010.m
%
% Script used to compare the evolution of the 3 erosion variables
% between observations, modeled from observed K, modeled from best
% K. This version of the script is similar to obs_vs_model.m, but
% with 2009 values and considering standard error calculated from
% bootstrap analysis.
%
%
%
