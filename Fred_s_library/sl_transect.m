function sl_transect(cnvFiles)

%usage ex: >> sl_transect('20130609T1')
% where '20130609T1' is generated in lnux by:
% 'ls mypattern*.cnv > 20130609T1
%
% F. Cyr - june 2013
...
shading interp
hold on
contour(x, Pbin, TMat, 'linecolor', 'k')
set(gca, 'ydir', 'reverse')
xmoor = m_lldist([Lon(1) moorLon], [Lat(1) moorLat]);
plot([xmoor xmoor], [max(Pbin) min(Pbin)], 'color', [1 1 1], 'linestyle', '--')
xlabel('distance from cliff (km)')   
