function timedepth_map(eps_files, epsMin, epsMax, varargin)

% function timedepth_eps(no_profile, epsMin, epsMax, varargin)
% was previously isopyc_tidecycle.m
% 
% ex: timedepth_map('epsProfiles1001.list', 1e-9, 1e-5, 200, 1)
%
% Now run from anywhere:
% timedepth_map('~/PhD/WINDEX/MissionTadoussac/epsProfiles1001.list', 1e-9, 1e-5, 150, 1)
...
ylabel(cb,'log_{10}(\epsilon / W kg^{-1})', 'FontSize', 15)
xlim([t0 tf])
...
xlim([t0 tf])
ylabel(cb,'T (^{\circ}C)', 'FontSize', 15)
caxis([0 6])
set(gca, 'fontsize', 15)
...
print('-dpng', '-r300', 'timedepth_pumpPaper.png');
set(gcf, 'renderer', 'painters')
print('-depsc2', 'timedepth_pumpPaper.eps');
