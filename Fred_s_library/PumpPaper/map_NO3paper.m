...
%load '/home/cyrf0006bea/data/Topo_Gulf_St_Lawrence.mat'
...
m_text(-69.79, 48.156604, 'Tadoussac', 'vertical', 'bottom', 'horizontal', 'center', 'color', 'k','FontSize', FS, 'FontWeight', 'bold');
m_line(-68.522186, 48.482571, 'marker','o','MarkerFaceColor','k','markersize',6,'color','k');
m_text(-68.522186, 48.482571, 'Rimouski', 'vertical', 'top', 'horizontal', 'left', 'color', 'k','FontSize', FS, 'FontWeight', 'bold');
m_line(-67.386367, 49.320459, 'marker','o','MarkerFaceColor','k','markersize',6,'color','k');
m_text(-67.386367, 49.320459, 'Pointe-des-Monts', 'vertical', 'bottom', 'horizontal', 'right', 'color', 'k','FontSize',FS, 'FontWeight', 'bold');
m_line(-69.55578, 48.068817, 'marker','o','MarkerFaceColor','k','markersize',6,'color','k');
m_text(-69.55578, 48.068817, 'Ile-Rouge', 'vertical', 'top', 'horizontal', 'left', 'color', 'k','FontSize',FS, 'FontWeight', 'bold');
m_text(-69.85, 48.25, '\leftarrow', 'rotation', 45, ... 
           'verticalAlignment', 'bottom', 'horizontalAlignment', 'center', ...
           'fontweight', 'bold', 'fontsize', FS, 'color', 'k');
m_text(-69.8, 48.35, 'Saguenay', 'vertical', 'bottom', 'horizontal', 'center', 'color', 'k','FontSize',FS, 'FontWeight', 'bold');
m_text(-69.8, 48.35, 'River', 'vertical', 'top', 'horizontal', 'center', 'color', 'k','FontSize',FS, 'FontWeight', 'bold');
...
m_text(-68.5885, 48.6627, 'Stat. 23', 'vertical', 'bottom', 'horizontal','right', 'color', [0 0 0],'FontSize',FS2, 'FontWeight', 'bold')
...
m_text(lon_max, lat_max, 'Stat. 25', 'vertical', 'bottom', 'horizontal','right', 'color', [0 0 0],'FontSize',FS2, 'FontWeight', 'bold')
...
[loma, lama] = m_ll2xy(lon_max,lat_max);
rectangle('Position', [lomi lami loma-lomi lama-lami],'linewidth', 1, 'edgecolor', 'k') 
m_text(lon_max, lat_max, 'Stat. 24', 'vertical', 'bottom', 'horizontal','right', 'color', [0 0 0],'FontSize',FS2, 'FontWeight', 'bold')
...
[loma, lama] = m_ll2xy(lon_max,lat_max);
rectangle('Position', [lomi lami loma-lomi lama-lami],'linewidth', 1, 'edgecolor', 'k') 
m_text(lon_max, lat_max, 'Stat. 22', 'vertical', 'bottom', 'horizontal','right', 'color', [0 0 0],'FontSize',FS2, 'FontWeight', 'bold')
...
m_line(mean(SFLon), mean(SFLat),'marker','p', 'color', 'k','MarkerFaceColor',[1 1 1] ,'markersize',15);
...
% $$$     m_line(latLon(i,2), latLon(i,1),'marker','p', 'color', 'm', 'MarkerFaceColor','m' ,'markersize',15);
...
ti = ylabel(c,'Depth (m)', 'FontSize', FS2);
...
m_text(-60.4, 47.3, 'Cabot', 'vertical', 'bottom', 'horizontal', 'left', 'color', 'k','FontSize',FS3, 'FontWeight', 'bold')
m_text(-60.3, 47.3, 'Strait', 'vertical', 'top', 'horizontal', 'left', 'color', 'k','FontSize',FS3, 'FontWeight', 'bold')
% $$$ m_text(-63, 48.8, 'Laurentian', 'vertical', 'bottom', ...
% $$$        'horizontal', 'left', 'color', 'k','FontSize',FS3, 'rotation', -26)
% $$$ m_text(-63, 48.8, 'Channel', 'vertical', 'top', ...
% $$$        'horizontal', 'left', 'color', 'k','FontSize',FS3, 'rotation', -26)
m_text(-59, 46.8, 'Laurentian', 'vertical', 'bottom', ...
       'horizontal', 'left', 'color', 'k','FontSize',FS3, 'rotation', -38, 'FontWeight', 'bold')
m_text(-59, 46.8, 'Channel', 'vertical', 'top', ...
       'horizontal', 'left', 'color', 'k','FontSize',FS3, 'rotation', -38, 'FontWeight', 'bold')
m_text(-63.364105, 48.25, 'Gulf of', 'vertical', 'bottom', ...
       'horizontal', 'left', 'color', 'k','FontSize',FS3, 'rotation', 0, 'FontWeight', 'bold')
m_text(-63.364105, 48.25, 'St. Lawrence', 'vertical', 'top', ...
       'horizontal', 'left', 'color', 'k','FontSize',FS3, 'rotation', 0, 'FontWeight', 'bold')
m_text(-68.522186, 48.482571, 'LSLE', 'vertical', 'top', 'horizontal', 'left', 'color', 'k','FontSize',FS3, 'FontWeight', 'bold');
