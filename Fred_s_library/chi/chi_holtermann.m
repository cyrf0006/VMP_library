function [chi,epsilon,zfft, ratio] = chi_holtermann(dtdz, z, zs, W, visc, zbin)
...
for i = 1:length(zfft)
    ...
    ps0 = ps0(J);
    f0 = f0(J);
    disp('Prblem I discussed with Peter!!!! Check this!')
    keyboard
    % ------------------------------------- %
    ...
    visco = visc; % <------ better if temperature dependent (see Holtermannscript.m)
    ...
    disp('Peter, press any key or remove this line')
    pause
    % ----
