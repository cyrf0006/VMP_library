...
% $$$     z0_0 = 1;
    ...
    U0 = a0(1)./kappa.*log(Z./a0(2)) + a0(2)*a0(1).^2/1e-6;
    ...
    U1 = asol(1)./kappa.*log(Z./asol(2)) + asol(2)*asol(1).^2/1e-6;
    plot(U1, Z, 'r--')
    hold off
    title(sprintf('%d', i))
...
save predicted_eps_contours.mat reg_tide myZ eps