function obs_vs_model_cmos(month, model_Kobs, model_Kcst, model_N)
...
%
% usage ex: 
% >> monthly_clim_model([4 5 6 7 8 9 10 11], 'T_diffus_daily.dat', 'N_diffus_daily.dat')
% >> obs_vs_model([4 5 6 7 8 9 10 11], 'T_diffus_daily_Kobs.dat',
% 'T_diffus_daily_5p5e-5.dat', 'N_diffus_daily.dat')
% >> obs_vs_model_cmos([4 5 6 7 8 9 10 11], 'T_diffus_daily_Kobs.dat', 'T_diffus_daily_Kveryveryall.dat', 'N_diffus_daily.dat')
%
...
Rplot = plot(N, Tmin_o_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'k','linestyle', '-', 'linewidth', 1.5)
hold on
Rplot = plot(N, Tmin_ko_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'r','linestyle', '-', 'linewidth', 1.5)
Rplot = plot(N, Tmin_kc_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'b','linestyle', '-', 'linewidth', 1.5)
%legend('observ', '{K_i}', '{K_a}', 'location', 'northwest')
...
n=N;
text(n_fit(1),ytext_tmin ,{['T_{min}=0.24\pm 0.04 ^{\circ}C ' ...
                   'mo^{-1}']}, 'VerticalAlignment','top', 'FontSize',10)
hold off
...
Rplot = plot(N, thick_o_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'k','linestyle', '-', 'linewidth', 1.5)
hold on
Rplot = plot(N, thick_ko_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'r','linestyle', '-', 'linewidth', 1.5)
Rplot = plot(N, thick_kc_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'b','linestyle', '-', 'linewidth', 1.5)

% $$$ hl = legend('observ', '{K_i}', '{K_a}', 'location', 'southwest')
% $$$ set(hl,'FontSize',8);
% $$$ plot(N, thick_o, '*k')
% $$$ hold on
% $$$ plot(N, thick_ko, 'or')
...
text(n_fit(1),ytext_thick ,{'d=-11\pm 2 m mo^{-1}'},'VerticalAlignment','bottom', 'FontSize',10)
hold off
...
Rplot = plot(N, heat_o_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'k','linestyle', '-', 'linewidth', 1.5)
hold on
Rplot = plot(N, heat_ko_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'r','linestyle', '-', 'linewidth', 1.5)
Rplot = plot(N, heat_kc_fit);%, 'k', 'linewidth', 1.5);
set(Rplot, 'color', 'b','linestyle', '-', 'linewidth', 1.5)
...
text(n_fit(1),ytext_heatc ,{'H=0.6 \pm 0.1 MJ m^{-3} mo^{-1}'},'VerticalAlignment','top', 'FontSize',10)
hold off
