...
% * [Nasmyth] a 3-dimensional matrix of the Nasmyth spectra for each
...
%      slow vectors.
% * [method] a matrix indicating the method used to make each
%      dissipation estimate. A value of 0 indicates the variance method and a
%      value of 1 indicates the inertial subrange fitting method. Its size
%      [N P] where N is the number of shear probes and P is the number of
%      dissipation estimates. 
% * [DOF] a matrix of the degrees of freedom in each dissipation
%      estimate. Its size [N P] where N is the number of shear probes and P
%      is the number of estimates.
...
%       wavenumber range used to make each dissipation estimate. DOF and
%       MAD are used for quality control of the dissipation estimates.
...
diss.sh           = complex(zeros(F_length, num_of_shear, num_of_shear, num_of_estimates));
